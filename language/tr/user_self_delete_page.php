...
$lang = array_merge($lang, array(
	...
	'USER_SELF_DELETE_EXPLAIN'		=>  'Doğrulama kutusunu işaretleyerek ve onaylama düğmesine tıklayarak kullanıcı hesabınızı bu forumda silmeyi kabul edersiniz.<br/>Tüm yayınlarınız değişmeden kalır, ancak artık kullanıcı adınız / şifrenizle bağlantı kuramazsınız.<br/>Aynı kullanıcı adıyla bir hesap oluşturursanız, önceki gönderi yeni hesap numarasına bağlanmayacaktır.',
	'USER_SELF_DELETE_VERIFY'		=>  'Sonuçları anlıyorum ve doğruluyorum',
	'HAVE_TO_LOGIN'					=>  'Üzgünüz, ama bu sayfayı görmek için giriş yapmalısın.',
