...
$lang = array_merge(
	...
	'ANDREASK_IUM_EMAIL_LIMIT_EXPLAIN' => 'Cantidad de recordatorios que pueden enviarse <b>por dia</b>. El valor recomendado es ~250. Pero consulte con su proveedor si existe algún límite de correos enviados al día.',
	...
	'ANDREASK_IUM_INCLUDED_FORUMS_EXPLAIN' => 'Seleccione una categoría o subcategoría a <strong>excluir</strong> de la lista de mejores temas que es enviada a los usuarios',
	'ANDREASK_IUM_EXCLUDED_FORUMS_EXPLAIN' => 'Seleccione una categoría o subcategoría a <strong>incluir</strong> de la lista de mejores temas que es enviada a los usuarios',
	'ANDREASK_IUM_IGNORE_GROUP_LIST_EXPLAIN' => 'Aquí puede seleccionar que grupo(s) deben ser ignorados por la extensión. Tenga en cuenta que los siguientes grupos están <strong>ignorados por defecto</strong> : 1. GUESTS (Invitados), 4. GLOBAL_MODERATORS (Moderadores globales), 5. ADMINISTRATOR (Administrador) y 6. BOTS (Bots). ¡Pero le sugerimos que seleccione aquí también dichos grupos!',
	'ANDREASK_IUM_GROUP_IGNORE_EXPLAIN' => 'Mantenga pulsado Control (CTRL) (o &#8984; en Mac) para seleccionar múltiples grupos.',
	// configuration page Legend
	'IUM_INACTIVE_USERS_EXPLAIN' => 'En esta lista puede ver los usuarios que se han registrado pero sus cuentas están inactivas y aquellos que no han visitado el foro por en el perído seleccionado.<br>El color del usuario representa su estado de ignorado. <span style="color: #DC143C;"><strong>Rojo</strong></span> -> Ignorado por un administrador, <span style="color: #008000;"><strong>Verde</strong></span> -> Auto-ignorado, <span style="color: #000000;"><strong>Negro</strong></span> -> No ignorado.',
	...
	'SOMETHING_WRONG' => 'Algo falló con su solicitud. Los usuarios solicitados a borrar no coinciden con los usuarios actuales de la base de datos',
