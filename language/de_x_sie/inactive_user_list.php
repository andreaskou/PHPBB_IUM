...
$lang = array_merge(
	...
	'IUM_INACTIVE_USERS_EXPLAIN'		=>	'In dieser Liste können Sie die Benutzer sehen, die sich registriert haben, aber deren Konten inaktiv sind, sowie diejenigen, die das Forum für die eingestellte Zeitspanne nicht besucht haben.<br>Die Farben der Benutzernamen stellen den Ignorier Status dar. <span style="color: #DC143C;"><strong>Rot</strong></span> -> Von einem Administrator ignoriert, <span style="color: #008000;"><strong>Grün</strong></span> -> Auto Ignoriert, <span style="color: #000000;"><strong>Schwarz</strong></span> -> Nicht ignoriert.',
