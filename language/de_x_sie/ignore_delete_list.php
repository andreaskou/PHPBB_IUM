...
$lang = array_merge(
	...
	'SELECT_AN_ACTION'							=>	'Wählen Sie eine Aktion',
	...
	'ANDREASK_IUM_IGNORE_GROUP_LIST_EXPLAIN'	=>	'Hier können Sie auswählen, welche Gruppe(n) von der Erweiterung ignoriert werden sollen. Bitte beachten Sie, dass, auch wenn sie <u>nicht</u> hier ausgewählt werden,</br>BOTS, ADMINISTRATOREN, MODERATOREN und GÄSTE <b>Ignoriert</b> werden. Es wird aber trotzdem vorgeschlagen, auch hier die Gruppen auszuwählen!',
	'ANDREASK_IUM_GROUP_IGNORE_EXPLAIN'			=>	'Halten Sie die Steuerung (CTRL) (oder &#8984; auf dem Mac) auf der Tastatur gedrückt, um mehrere Gruppen auszuwählen.',
	'ANDREASK_IUM_IGNORE_LIST_EXPLAIN'			=>	'Hier können Sie die Benutzer verwalten, die Sie ignorieren (keine Erinnerung senden) oder aus der Ignorieren-Liste entfernen möchten. <br/><strong>Jeder Benutzer in einer neuen Zeile.</strong><br/>Beachte, die folgenden Gruppen werden <strong> standardmäßig ignoriert</strong> : 1. Gäste, 2. Globale Moderatoren, 3. Administratoren und 4. Bots',
