...
$lang = array_merge(
	...
	'DELETE_REQUEST_DONT_MATCH'			=>	'Что-то не так с вашим запросом. Запрошенные пользователи для удаления не совпадают с фактическими пользователями в базе данных',
