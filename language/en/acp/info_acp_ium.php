...
$lang = array_merge(
	...
	'ANDREASK_IUM_TOP_USER_THREADS'	=>	'Include user\'s top topics?<br/>FOR NOW THIS CONFIGURATION IS INACTIVE.<br/>EXTENSION IS STILL <strong>UNDER DEVELOPMENT</strong>',
	'ANDREASK_IUM_TOP_USER_THREADS_COUNT'	=>	'How many topics?<br/>FOR NOW THIS CONFIGURATION IS INACTIVE.<br/>EXTENSION IS STILL <strong>UNDER DEVELOPMENT</strong>',
	'ANDREASK_IUM_TOP_FORUM_THREADS'	=>	'Include board\'s top topics?<br/>FOR NOW THIS CONFIGURATION IS INACTIVE.<br/>EXTENSION IS STILL <strong>UNDER DEVELOPMENT</strong>',
	'ANDREASK_IUM_TOP_FORUM_THREADS_COUNT'	=>	'How many topics?<br/>FOR NOW THIS CONFIGURATION IS INACTIVE.<br/>EXTENSION IS STILL <strong>UNDER DEVELOPMENT</strong>',
