...
$lang = array_merge($lang, array(
	...
	'ANDREASK_IUM_TOP_USER_THREADS'             =>  'Include user top threads?<br/>FOR NOW THIS CONFIGURATION IS INACTIVE.<br/>EXTENSION IS STILL <strong>UNDER DEVELOPMENT</strong>',
	'ANDREASK_IUM_TOP_USER_THREADS_COUNT'       =>  'How many threads?<br/>FOR NOW THIS CONFIGURATION IS INACTIVE.<br/>EXTENSION IS STILL <strong>UNDER DEVELOPMENT</strong>',
	'ANDREASK_IUM_TOP_FORUM_THREADS'          	=>  'Include forum top threads?<br/>FOR NOW THIS CONFIGURATION IS INACTIVE.<br/>EXTENSION IS STILL <strong>UNDER DEVELOPMENT</strong>',
	'ANDREASK_IUM_TOP_FORUM_THREADS_COUNT'    	=>  'How many threads?<br/>FOR NOW THIS CONFIGURATION IS INACTIVE.<br/>EXTENSION IS STILL <strong>UNDER DEVELOPMENT</strong>',
	'ANDREASK_IUM_SELF_DELETE'  				=> 	'User self delete<br/>FOR NOW THIS CONFIGURATION IS INACTIVE.<br/>EXTENSION IS STILL <strong>UNDER DEVELOPMENT</strong>',
	...
	'ANDREASK_IUM_TOP_USER_THREADS_COUNT_EXPLAIN'   =>  'Amount of user\'s top threads that should be included in the e-mail.',
