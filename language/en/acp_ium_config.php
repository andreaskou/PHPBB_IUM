...
$lang = array_merge(
		$lang, array(
			...
			'ANDREASK_IUM_ENABLE'	=>	'Activate Advanced Inactive User Reminder ',
			...
			'ANDREASK_IUM_ENABLE_EXPLAIN'	=>	'If activated, the extension will start sending reminders to "sleepers".',
			...
			'ANDREASK_IUM_EMAIL_LIMIT_EXPLAIN'	=>	'Number of reminders that can be sent <b>per day</b>. Recommended is ~250. But do check with your provider for any limit of e-mails per day',
			'ANDREASK_IUM_TOP_USER_THREADS_EXPLAIN'	=>	'If selected, mail will include user’s top active topics since user’s last visit.',
			'ANDREASK_IUM_TOP_USER_THREADS_COUNT_EXPLAIN'	=>	'Number of user’s top topics that should be included in the e-mail.',
			'ANDREASK_IUM_TOP_FORUM_THREADS_EXPLAIN'	=>	'If selected, mail will include board’s top topics since user’s last visit.',
			'ANDREASK_IUM_TOP_FORUM_THREADS_COUNT_EXPLAIN'	=>	'Number of forum topics that should be included in e-mail',
			'ANDREASK_IUM_SELF_DELETE_EXPLAIN'	=>	'If activated, a link to a page "<strong>board_url/ium/{random_key}</strong>" will be included to user and they will be able to self delete their account.',
			'ANDREASK_IUM_DELETE_APPROVE_EXPLAIN'	=>	'If activated all self delete request will have to be approved by the administrator.',
			...
			'ANDREASK_IUM_AUTO_DEL_DAYS_EXPLAIN'	=>	'Number of days before auto-deleting the user(s) from the requested day.',
			...
			'ANDREASK_IUM_EXCLUDED_FORUMS_EXPLAIN'	=>	'Select a category or subcategory to <strong>include</strong> it for the top topics lists that are sent to the users',
			'ANDREASK_IUM_IGNORE_LMT_EXPLAIN'		=>	'If "Yes" the extension will send only 3 reminders, if no the extension will continue sending reminders using the 3rd interval',
			'ANDREASK_IUM_RESPECT_USR_EXPLAIN'		=>	'Some users may have chosen to not receive mass mail messages from admins. If "Yes" the extension will not send the reminder to these users.',
			'ANDREASK_IUM_NO_REPLY_EXPLAIN'	=> 'If you would like you can specify a <strong>reply/no reply</strong> e-mail, if left blank the extension will use the board’s contact information.',
