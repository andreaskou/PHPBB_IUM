...
$lang = array_merge(
		$lang, array(
			...
			'ANDREASK_IUM_NO_REPLY_EXPLAIN'	=> 'If you would like you can specify a <strong>reply/no reply</strong> e-mail, if left blank the extension will use the board’s contact inofrmation.',
